...
int main(){
	...
	if(!(child1 = fork())){
		...
		int pid = getpid();
			    ...
			    char *strFileName = "./earthquake2processaa";    
			    char *strFileSummary = "./earthquake2process_part1.csv";
		...
		// only child2 executes this
			    char *strFileName = "./earthquake2processab";    
			    char *strFileSummary = "./earthquake2process_part2.csv";
			    char strTempData[MAX_LEN]; 
				char **strData = NULL; // String List
